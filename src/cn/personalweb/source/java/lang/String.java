...
public final class String
    ...
    */
    ...
    public int hashCode() {
        ...
        if (h == 0 && value.length > 0) {
            ...
            for (int i = 0; i < value.length; i++) {
                // 为什么是 31? 质数获取的 hash 重复率低, 并且编译器对 31 这里有优化,31 * i ==  (i<<5)-i.
                h = 31 * h + val[i];
            }
            hash = h;
        }
    ...
    public String concat(String str) {
        ...
        // 使用 Arrays.copyOf() 方法, 此操作做了一个拷贝操作, 并为需要新增加的字符串预留的位置.
        char buf[] = Arrays.copyOf(value, len + otherLen);
        // 从 len 长度开始, 将 str 字符串复制到 buf 中
